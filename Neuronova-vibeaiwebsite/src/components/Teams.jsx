    ...
    <section className="section" id="teams">
      <div className="container">
        <SectionHeader index="05" label="ORGANIZATION" title="Structured like a company.">
          Specialist teams, each with its own Leader review step, plus a CEO-style oversight
        ...
        <div className="ceo-card spotlight-card" data-reveal>
          <div className="ceo-left">
            ...
            <p>
              ...
              well?</em> It compiles from real operational logs, not marketing copy.
            </p>
          </div>
